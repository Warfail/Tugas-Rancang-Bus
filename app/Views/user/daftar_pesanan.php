...
<body>
    ...
    <form action="../../Pemesanan/prosespesan" method="post">
        <div class="mb-3">
            ...
            <input type="text" name="id_pemesanan" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder" value="<?= substr($datas2['id_pemesanan'], 0, 1) . str_pad((int)substr($datas2['id_pemesanan'], 1) + 1, 6, '0', STR_PAD_LEFT); ?>">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="id_bus" class="form-control" id="formGroupExampleInput2" placeholder="Another input placeholder" value="<?= $datas['id_bus']; ?>">
        </div>
        <div class="mb-3">
